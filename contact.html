		...
		<div id="header_container">		
			...
			<!-- Header -->
				<div id="header" class="row">
					<div class="4u">
						<h1><a href="index.html">CCS3<span class="header_colour">_responsive</span></a></h1>
		...
		<div id="footer_container">
			...
			<!-- Footer -->
				<footer>
					...
					<p>Copyright &copy; CSS3_responsive | <a href="http://skeljs.org/">skel.js</a> | <a href="http://www.css3templates.co.uk">design from css3templates.co.uk</a></p>
				</footer>		
			</div>
        </div>		
	</body>
